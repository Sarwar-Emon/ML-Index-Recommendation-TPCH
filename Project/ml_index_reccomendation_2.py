"""
================================================================
ML-Based Index Recommendation System v2 (FIXED)
================================================================
Fixes applied:
...
OUTPUT_DIR  = "ml_results_v2"

os.makedirs(OUTPUT_DIR, exist_ok=True)

print("=" * 65)
print("  ML-Based Index Recommendation System v2 (FIXED)")
...
plt.tight_layout()
plt.savefig(os.path.join(OUTPUT_DIR,'fig1_model_comparison_v2.png'), bbox_inches='tight')
plt.close()
print("  Saved: fig1_model_comparison_v2.png")
...
plt.tight_layout()
plt.savefig(os.path.join(OUTPUT_DIR,'fig2_confusion_matrices_v2.png'), bbox_inches='tight')
plt.close()
print("  Saved: fig2_confusion_matrices_v2.png")
...
ax.legend()
plt.tight_layout()
plt.savefig(os.path.join(OUTPUT_DIR,'fig3_feature_importance_v2.png'), bbox_inches='tight')
plt.close()
print("  Saved: fig3_feature_importance_v2.png")
...
plt.tight_layout()
plt.savefig(os.path.join(OUTPUT_DIR,'fig4_cv_scores_v2.png'), bbox_inches='tight')
plt.close()
print("  Saved: fig4_cv_scores_v2.png")
...
plt.tight_layout()
plt.savefig(os.path.join(OUTPUT_DIR,'fig5_roc_curves_v2.png'), bbox_inches='tight')
plt.close()
print("  Saved: fig5_roc_curves_v2.png")
...
ax.grid(True, alpha=0.3, axis='y')
plt.tight_layout()
plt.savefig(os.path.join(OUTPUT_DIR,'fig6_label_validation_v2.png'), bbox_inches='tight')
plt.close()
print("  Saved: fig6_label_validation_v2.png")
...
perf_df.to_csv(os.path.join(OUTPUT_DIR,'model_performance_v2.csv'), index=False)
...
fi_df.to_csv(os.path.join(OUTPUT_DIR,'feature_importance_v2.csv'), index=False)

# Classification reports
with open(os.path.join(OUTPUT_DIR,'classification_reports_v2.txt'), 'w') as f:
    f.write("=" * 60 + "\n")
...
rec_df.to_csv(os.path.join(OUTPUT_DIR,'index_recommendations_v2.csv'), index=False)

# Full summary JSON
summary = {
    'version': 'v2 - no data leakage',
    'environment': {
...
print("  Saved: model_performance_v2.csv")
print("  Saved: feature_importance_v2.csv")
print("  Saved: classification_reports_v2.txt")
print("  Saved: index_recommendations_v2.csv")
print("  Saved: summary_v2.json")
